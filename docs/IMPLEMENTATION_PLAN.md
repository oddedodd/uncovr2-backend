...
- [ ] `B1.9` Document API naming, pagination, filtering, sorting and timestamps.

### B1 gate

- [ ] Versioned API routes respond with the agreed format.
- [ ] Health checks, rate limits and error handling have automated tests.
